...
export function MilestoneChecklist({ childId, ageKey }: MilestoneChecklistProps) {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>(() => {
    ...
    return categoryParam && ["social", "language", "cognitive", "movement"].includes(categoryParam)
      ? categoryParam
      : "all"
  })
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 space-y-4">
        ...
        {child.dueDate && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-blue-700">Using corrected age for premature development tracking</span>
              <button
        ...
        <div className="flex flex-wrap gap-1" role="tablist" aria-label="Category filters">
          <Button
          ...
          {categories.map((category) => {
            ...
            return (
              <Button
                ...
                className="min-h-[36px] capitalize text-sm"
                role="tab"
        ...
        <div className="space-y-3" role="main">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <h3 className="font-medium leading-snug text-sm">{item.label}</h3>
                        ...
                        {item.mediaUrl && (
                          <button
                            ...
                            className="flex-shrink-0 w-12 h-12 rounded-lg overflow-hidden border hover:border-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 relative group"
                            aria-label={`View example video or image for ${item.label}`}
                          >
                            <img
                              src={item.mediaUrl || "/placeholder.svg?height=48&width=48"}
                              alt=""
                    ...
                    <div className="flex gap-2" role="radiogroup" aria-labelledby={`item-${item.id}-label`}>
                      ...
                      <Button
                        ...
                        className={`flex-1 min-h-[36px] text-sm transition-all ${
                          response?.answer === "yes"
                    ...
                    {response && (
                      <div className="space-y-2">
                        <Button
                          ...
                          className="flex items-center gap-2 text-xs min-h-[32px]"
                        ...
                        {response.note && !isExpanded && (
                          <div className="bg-muted p-2 rounded-lg">
                            <p className="text-xs">{response.note}</p>
                          </div>
                        )}
                      </div>
                    )}
              ...
              <div className="grid gap-3">
                <Button
                  ...
                  onClick={() => {
                    ...
                    router.push("/health-plan?tab=goals")
                  }}
