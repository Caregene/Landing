            ...
            <CardContent className="pt-0">
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="flex-1 min-h-[44px] ml-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium rounded-full"
